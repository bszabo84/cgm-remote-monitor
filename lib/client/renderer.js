...
function init (client, d3) {
  ...
  renderer.drawTreatments = function drawTreatments (client) {
    ...
    // if (env.hide_treatments === 'true'){
    if (client.settings.hide_treatments === 'true'){
      console.log("'MONGO_HIDE_TREATMENTS' environment variable set -> skipping treatment rendering.");
      return;
    }
